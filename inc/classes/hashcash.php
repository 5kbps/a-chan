...
function hc_CreateStamp()
{
	...
	//embed stamp in page
	$r = "<input type=\"hidden\" name=\"hc_stamp\" id=\"hc_stamp\" value=\"" . $stamp . "\" />\n";
	//$r .= "<input type=\"hidden\" name=\"hc_contract\" id=\"hc_contract\" value=\"" . $hc_contract . "\" />\n";
	$r .= "<input type=\"hidden\" name=\"hc_contract\" id=\"hc_contract\" value=\"12\" />\n";
	$r .= "<input type=\"hidden\" name=\"hc_collision\" id=\"hc_collision\" value=\"" . $hc_maxcoll . "\" />\n";
	return $r;
}
