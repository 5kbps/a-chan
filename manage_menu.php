...
if (!$manage_class->ValidateSession(true)) {
	...
	<li>'._gettext('Posting rates').' <a href="manage_page.php?action=posting_rates&period=3600">h</a>
	<a href="manage_page.php?action=posting_rates&period=86400">d</a>
	<a href="manage_page.php?action=posting_rates&period=604800">w</a>
	<a href="manage_page.php?action=posting_rates&period=2592000">m</a>
	<a href="manage_page.php?action=posting_rates&period=total">all</a>
	</li>
	...
	if ($manage_class->CurrentUserIsAdministrator()) {
		...
		<li><a href="manage_page.php?action=globallog">' . _gettext('Global log') . '</a></li>
		...
		<li><a href="manage_page.php?action=antiwipe">' . _gettext('Antiwipe') . '</a></li>
		...
		<li><a href="manage_page.php?action=sessionsearch">' . _gettext('Session Search') . '</a></li>
		...
		<li><a target="_blank" href="manage_page.php?action=rebuildall">' . _gettext('Rebuild all html files') . '</a></li>' . "\n" .
		'</ul></div>';
