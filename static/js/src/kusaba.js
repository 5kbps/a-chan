    ...
    for (var i = 0; i < c.length; i++) {
        ...
        if (d.getAttribute('id')) {
            if (d.getAttribute('id').substr(0, 3) == 'dnb') {
                ...
                f += '&#91;<a href="' + config.ku_cgipath + '/manage_page.php?action=delposts&boarddir=' + e[1] + '&del';
                if (e[3] == 'y') {
                    f += 'thread'
                } else {
                    f += 'post'
                }
                f += 'id=' + e[2] + '" title="' + _('Delete') + '" onclick="return confirm(_(\'Are you sure you want to delete this post/thread?\'));">D<\/a>&nbsp;<a href="' + config.ku_cgipath + '/manage_page.php?action=delposts&boarddir=' + e[1] + '&del';
                if (e[3] == 'y') {
                    f += 'thread'
                } else {
                    f += 'post'
                }
                f += 'id=' + e[2] + '&postid=' + e[2] + '" title="' + _('Delete &amp; Ban') + '" onclick="return confirm(_(\'Are you sure you want to delete and ban the poster of this post/thread?\'));">&amp;<\/a>&nbsp;<a href="' + config.ku_cgipath + '/manage_page.php?action=bans&banboard=' + e[1] + '&banpost=' + e[2] + '" title="' + _('Ban') + '">B<\/a>&#93;&nbsp;&#91;<a href="' + config.ku_cgipath + '/manage_page.php?action=bans&banboard=' + e[1] + '&banpost=' + e[2] + '&instant=y" title="' + _('Instant Permanent Ban') + '" onclick="instantban(\'' + e[1] + '\',' + e[2] + '); return false;">P<\/a>&#93;&nbsp;&#91;<a href="' + config.ku_cgipath + '/manage_page.php?action=delposts&boarddir=' + e[1] + '&del';
                if (e[3] == 'y') {
                    f += 'thread'
                } else {
                    f += 'post'
...
function instantban(c, d) {
    ...
    if (e !== null) {
        var f = config.ku_cgipath + '/manage_page.php?action=bans&banboard=' + c + '&banpost=' + d + '&instant=y';
        if (e != '') {
            f += '&reason=' + e
        }
        new Ajax.Request(f, {
